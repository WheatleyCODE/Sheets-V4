...
import { ITemplateDetailsCommentsSchema, ITemplateDetailsRecommendsSchema } from 'pages/template-details-page';
...
export interface IStateSchema {
  ...
  templateDetailsRecommends?: ITemplateDetailsRecommendsSchema;

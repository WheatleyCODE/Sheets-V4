...
page - Компонент c единственной ответственностью - отображение наполнения страницы, в нем не должно быть логики кроме отображения виджетов и фичей

widget - Самостоятельный блок, который имеет доступ
